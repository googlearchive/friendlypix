# Contributing to the OAuth 2.0 Playground

We'd love for you to contribute to our source code and to make the OAuth 2.0 Playground even better than it is today! Here are the guidelines we'd like you to follow:
...
If you have questions about how to use Material Design Lite, please direct these to [StackOverflow][stackoverflow] and use the `oauth2-playground` tag. We are also available on GitHub issues.
...
* Search [GitHub](https://github.com/google/oauthplayground/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `oauthplayground:master`.
* If we suggest changes then:
  * Make the required updates.
  * Re-run the OAuth 2.0 Playground test suite to ensure tests are still passing.
...
We generally follow the [Google JavaScript style guide][js-style-guide] and the [Google Python style guide][py-style-guide].
...
[github]: https://github.com/google/oauthplayground
...
[stackoverflow]: http://stackoverflow.com/questions/tagged/oauth2-playground
