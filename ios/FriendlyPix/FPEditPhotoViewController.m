...
- (void)doneButtonAction:(id)sender {
  ...
  NSDictionary * data = @{ @"url" : @"http://scontent-a.cdninstagram.com/hphotos-xaf1/t51.2885-15/10914199_783690465011698_1793039066_s.jpg",
                           @"text" : trimmedComment,
                           @"location": @"1",
  ...
  [[ref childByAppendingPath: [NSString stringWithFormat:@"users/%@/posts/%@", [FPAppState sharedInstance].currentUser.userID, postId]] setValue:[NSNumber numberWithBool:YES]];
